...
/*   Updated: 2024/07/07 19:00:53 by jakim            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (type == 0)
		return ((time.tv_sec - time2.tv_sec) * 1000 \
		+ (time.tv_usec - time2.tv_usec) / 1000);
	else
		return ((time.tv_sec - time2.tv_sec) * 1000 \
		+ (time.tv_usec - time2.tv_usec - 1000) / 1000);
}
